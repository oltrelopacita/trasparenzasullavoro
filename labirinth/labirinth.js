...
const hintsTransparent = [
  ...
  { id: 6, x: 3, y: 13, text: 'Prosegui verso sinistra.' },
  ...
  { id: 10, x: 15, y: 37, text: 'Fai 6 passi a destra e poi svolta.' },
  { id: 18, x: 23, y: 39, text: 'Svolta al secondo incrocio.' },
  { id: 12, x: 29, y: 35, text: 'Prosegui verso destra.' },
  ...
  { id: 19, x: 3, y: 21, text: "Vai a destra." },
  { id: 22, x: 24, y: 39, text: "Alla seconda curva svolta." },
  { id: 23, x: 38, y: 31, text: "Svolta verso il basso." },
];
